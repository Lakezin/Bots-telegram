...
if not TELEGRAM_TOKEN:
    raise ValueError("FINAL_TELEGRAM_TOKEN não encontrado no .env")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    teclado = [[
        InlineKeyboardButton(
            "🟢 Tarifa/Reembolsável por R$12,53", callback_data="vip"),
    ]]
    ...
    texto = (
        ...
        "Prezamos pela qualidade, segurança e privacidade dos nossos membros.\n\n"
        "Por isso, ativamos a Tarifa de Segurança Legal, um protocolo obrigatório de verificação.\n\n"
        "💳 Valor: *R$12,53*\n"
...
def webhook():
    ...
    try:
        ...
        if ID_GRUPO_VIP:
            ...
            if link:
                mensagem += f"🔗 Seu link exclusivo de acesso:\n{link}"
            else:
                print("Erro ao gerar invite link:", invite_resp)
                mensagem += "🔗 Seu acesso:\nhttps://t.me/+KWy9XRovaI9lNTMx"
        else:
            mensagem += "🔗 Seu acesso:\nhttps://t.me/+KWy9XRovaI9lNTMx"
