...
TELEGRAM_TOKEN = os.getenv("FINAL_TELEGRAM_TOKEN")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    teclado = [[
        InlineKeyboardButton(
            "🟢Tarifa/Reembolsavel por R$12,53", callback_data="vip"),
    ]]
    ...
    try:
        await update.message.reply_video(
            ...
            caption=(
                ...
                "Prezamos pela qualidade, segurança e privacidade dos nossos\n"
                "membros.\n"
                "Por isso, ativamos a Tarifa de Segurança Legal (T.S.L.), um protocolo\n"
                "obrigatório de verificação.\n"
                "💳O valor é simbólico, serve apenas como filtro de acesso seguro e é 100% reembolsável após a verificação.\n"
                "A\n"
                "Atenção:\n"
                "⚠Se você não concluir essa verificação agora, seu acesso será\n"
        ...
        await update.message.reply_text(
            "🟢Tarifa/Reembolsavel por R$12,53",
            reply_markup=reply_markup,
            parse_mode="Markdown",
        )
...
async def menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if texto == "💎 Comprar VIP":
        await update.message.reply_text("💎 VIP — R$12,53\n\nUse /start para ver a oferta.")
    elif texto == "📞 Suporte":
    ...
    try:
        ...
        if ID_GRUPO_VIP:
            ...
            if link:
                ...
                mensagem += "https://t.me/+KWy9XRovaI9lNTMx"
        else:
            mensagem += "https://t.me/+KWy9XRovaI9lNTMx"
